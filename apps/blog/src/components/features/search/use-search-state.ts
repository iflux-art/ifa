...
import { getSearchSuggestions, performSearch } from "@/components/features/search/search-engine";
import type { SearchOptions, SearchResult } from "@/components/features/search/search-types";
